...
| 6 | Migration: payouts, ledger reason `midweek_win`, the faucet ADR; Part L #26. Per HANDOFF.md: a member view of their own midweek rewards (migration `20261006000000`, ADR-096) | built, in review |
