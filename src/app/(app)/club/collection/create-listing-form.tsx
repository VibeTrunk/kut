  ...
  return (
    <form action={action} className="rounded-2xl border border-steel-line/35 bg-steel-bg/20 p-4">
      ...
      <p className="mt-1 text-sm text-steel/80">
        Choose a buy-now price from {minimumPrice} to {maximumPrice} KUT Coins. The listing lasts 24
        hours and locks this card.
      </p>
      ...
      <button
        ...
        type="submit"
      >
        {pending ? "Listing..." : "Create 24-hour listing"}
      </button>
    </form>
  );
}
