    ...
    <main className="min-h-screen bg-slate-950 p-5 text-slate-50 sm:p-10">
      <section className="mx-auto max-w-5xl space-y-8">
        <header>
          ...
          <p className="mt-3 max-w-2xl text-slate-300">Your club&apos;s standing across every Live Card you own. Open Collection to browse individual cards, or Packs to add more.</p>
        </header>

        <dl className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          <div className="rounded-2xl bg-amber-400 px-4 py-4 text-slate-950">
          ...
          <div className="rounded-2xl border border-cyan-400/40 bg-cyan-950/30 px-4 py-4">
          ...
          <div className="rounded-2xl border border-slate-700 bg-slate-950/60 px-4 py-4">
            <dt className="text-xs font-black uppercase tracking-[0.13em] text-slate-400">Unique players</dt>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Link className="group rounded-3xl border border-slate-700 bg-slate-900/70 p-6 hover:border-amber-400" href="/club/collection">
            <h2 className="text-xl font-black group-hover:text-amber-300">Browse Collection →</h2>
            <p className="mt-2 text-sm text-slate-400">Every Live Card and special edition you own, {cardCount} in total.</p>
          </Link>
          <Link className="group rounded-3xl border border-slate-700 bg-slate-900/70 p-6 hover:border-amber-400" href="/club/packs">
            <h2 className="text-xl font-black group-hover:text-amber-300">Open Packs →</h2>
            <p className="mt-2 text-sm text-slate-400">Spend KUT Coins on new tradeable Live Cards.</p>
          </Link>
        </div>
