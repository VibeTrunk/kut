    ...
    <main className="board-ground min-h-screen p-5 text-ink sm:p-10">
      <section className="mx-auto max-w-lg rounded-3xl border border-brick-line/40 bg-panel p-6 shadow-2xl shadow-board/50">
        ...
        <p className="mt-3 text-ink-dim">
          No game action was completed by this error. Try again, or return to Live Ratings and
          continue from there.
        </p>
        <div className="mt-6 flex flex-wrap gap-3">
          <button
            className="min-h-11 rounded-xl bg-brass px-4 font-black text-ink-on-accent"
            onClick={reset}
            type="button"
          >
            Try again
          ...
          <Link
            className="inline-flex min-h-11 items-center rounded-xl border border-line px-4 font-bold hover:border-brass"
            href="/"
          >
            Live Ratings
          </Link>
