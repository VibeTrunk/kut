  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <label className="block space-y-2">
        ...
        <input autoComplete="email" className="min-h-12 w-full rounded-xl border border-line bg-board px-4" name="email" required type="email" />
      </label>
      <label className="block space-y-2">
      ...
      <p className="text-sm text-ink-faint">Use at least 12 characters. Your invite can only be claimed once.</p>
