...
export default async function MarketPage({ searchParams }: MarketPageProps) {
  ...
  return <main className="min-h-screen bg-slate-950 p-5 text-slate-50 sm:p-10"><section className="mx-auto max-w-6xl space-y-7">
    <nav className="flex justify-between text-sm font-bold"><Link className="text-amber-400" href="/club">← My Club</Link><span className="text-slate-400">{balance} TF Coins</span></nav>
    <header><p className="text-sm font-black uppercase tracking-[0.24em] text-amber-400">Transfer market</p><h1 className="mt-2 text-4xl font-black tracking-tight sm:text-5xl">Buy Live Cards</h1><p className="mt-3 text-slate-300">Buy-now listings from other clubs. Prices are paid in TF Coins; a 5% tax is burned.</p></header>
